...
export const config = {
  ...
  social: {
    ...
    linkedin: {
      ...
      orgClientId: process.env.LINKEDIN_ORG_CLIENT_ID || process.env.LINKEDIN_CLIENT_ID,
      orgClientSecret: process.env.LINKEDIN_ORG_CLIENT_SECRET || process.env.LINKEDIN_CLIENT_SECRET,
      orgScope: process.env.LINKEDIN_ORG_SCOPE || 'openid profile w_organization_social r_organization_social',
      enableOrganizations: process.env.LINKEDIN_ENABLE_ORGANIZATIONS === 'true' || Boolean(process.env.LINKEDIN_ORG_CLIENT_ID),
    },
  },
  cloudinary: {
