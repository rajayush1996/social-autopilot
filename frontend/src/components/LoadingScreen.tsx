  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4 animate-fadeIn">
      <div className="relative">
        ...
        <div className="w-14 h-14 rounded-2xl bg-[var(--bg-card)] border border-[var(--border-color)] shadow-lg flex items-center justify-center relative z-10 overflow-hidden p-1.5">
          <img src="/omnisync-icon.png" alt="OmniSync Logo" className="w-full h-full object-contain animate-pulse" />
