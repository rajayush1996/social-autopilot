    ...
    return (
      <div className="min-h-screen bg-slate-955 text-slate-100 font-sans selection:bg-indigo-500/30 overflow-x-hidden relative">
        ...
        <header className="sticky top-0 z-50 w-full bg-slate-955/80 backdrop-blur-lg border-b border-slate-900/80">
          <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <span className="font-black text-sm tracking-wider text-white uppercase block">OmniSync</span>
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className="p-2 rounded-xl bg-slate-800/80 border border-slate-700 text-slate-200 hover:bg-slate-800 transition-all"
              >
                {theme === 'dark' ? (
              ...
              <Link href="/login" className="text-xs font-semibold text-slate-300 hover:text-white px-3 py-2">
                Sign In
              </Link>
              <Link 
                href="/signup" 
                className="text-xs font-bold text-white bg-indigo-600 hover:bg-indigo-500 px-4 py-2 rounded-xl transition-all shadow-md shadow-indigo-600/30"
              >
                Get Started
              </Link>
            </div>
        ...
        <section className="max-w-7xl mx-auto px-6 pt-16 pb-20 md:pt-24 md:pb-28 text-center space-y-8">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-black tracking-tight leading-[1.1] max-w-4xl mx-auto text-white">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 pt-4">
            <Link 
              href="/signup"
              className="px-6 py-3.5 rounded-2xl bg-gradient-to-r from-indigo-600 to-indigo-700 hover:from-indigo-500 hover:to-indigo-600 text-white font-bold text-sm shadow-xl shadow-indigo-600/25 transition-all flex items-center gap-2 group"
            >
              Start Free OmniSync
